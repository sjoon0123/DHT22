import pandas as pd
from adxl345_bus_data_base_class import ADXL345busDataBaseClass  # 이미 구현된 ADXL345busDataBaseClass를 import합니다.
...
# raw_adxl345_data = RawADXL345busDataClass(fileNamePrefix, SampleRate=1)
# raw_adxl345_data.plot()
